...
@responses.activate
def test_create_subaccount(subaccounts_client, business_name, settlement_bank, account_number, percent_charge, description, primary_contact_email, primary_contact_name, primary_contact_phone, metadata):
    """ Test for synchronous Customers """
...
@responses.activate
def test_update_subaccount(subaccounts_client, business_name, settlement_bank, account_number, active, percent_charge, description, primary_contact_email, primary_contact_name, primary_contact_phone, settlement_schedule, metadata):
    """ Test for synchronous Customers """
