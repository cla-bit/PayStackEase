...
@responses.activate
def test_initialize_transaction(transactions_client, email, amount, currency, reference, callback_url, plan,
...
@responses.activate
def test_charge_authorization(transactions_client, email, amount, authorization_code, reference, currency, channels, subaccount, transaction_charge, bearer, queue, metadata):
    """ Test for synchronous Customers """
...
@responses.activate
def test_partial_debit(transactions_client, email, amount, authorization_code, reference, currency, at_least):
    """ Test for synchronous Customers """
...
@responses.activate
def test_list_transactions(transactions_client, customer, terminal_id, amount, status, from_date, to_date, per_page, page):
    """ Test for synchronous Customers """
...
@responses.activate
def test_export_transactions(transactions_client, customer, currency, amount, status, settled, settlement, payment_page, from_date, to_date, per_page, page):
    """ Test for synchronous Customers """
