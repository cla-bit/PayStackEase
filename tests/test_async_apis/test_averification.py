...
async def test_resolve_account(async_verification_client, mocked_responses, account_number, bank_code):
    """ Test for synchronous Customers """
    ...
    response = await async_verification_client.resolve_account(account_number=account_number, bank_code=bank_code)
...
async def test_validate_account(async_verification_client, mocked_responses, account_name, account_number, account_type, bank_code, country_code, document_type, document_number):
    """ Test for synchronous Customers """
