...
async def test_create_subscription(async_subscriptions_client, mocked_responses, customer, plan_code, authorization, start_date):
    """ Test for synchronous Customers """
...
async def test_list_subscription(async_subscriptions_client, mocked_responses, customer, plan_code, per_page, page):
    """ Test for synchronous Customers """
...
async def test_enable_subscription(async_subscriptions_client, mocked_responses, subscription_code, token):
    """ Test for synchronous Customers """
...
async def test_disable_subscription(async_subscriptions_client, mocked_responses, subscription_code, token):
    """ Test for synchronous Customers """
...
@pytest.mark.asyncio
async def test_generate_update_subscription(async_subscriptions_client, mocked_responses):
    """ Test for synchronous Customers """
    ...
    response = await async_subscriptions_client.generate_update_subscription(subscription_code=sub_code)
    mocked_responses.assert_called()
...
async def test_send_update_subscription(async_subscriptions_client, mocked_responses):
    ...
    response = await async_subscriptions_client.send_update_subscription_link(subscription_code=sub_code)
    mocked_responses.assert_called()
    assert response == response_data
    assert response is not None
