...
async def test_charge_authorization(
    async_transactions_client,
    mocked_responses,
    email,
    amount,
...
async def test_fetch_transaction(async_transactions_client, mocked_responses):
    ...
    response = await async_transactions_client.fetch_transaction(
...
async def test_transaction_timeline(async_transactions_client, mocked_responses):
    ...
    response = await async_transactions_client.transaction_timeline(
        id_or_reference=transaction_id
    )
    mocked_responses.assert_called()
    assert response is not None
...
async def test_list_transactions(
    async_transactions_client, mocked_responses, from_date, to_date, per_page, page
):
    """Test for synchronous Customers"""
