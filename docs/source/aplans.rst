...
.. py:class:: AsyncPlanClientAPI(secret_key: str = None)
    ...
    .. py:method:: async create_plan(name: str, amount: int, interval: str, currency: str, invoice_limit: int, send_invoices: bool, send_sms: bool, description: str | None = None)→ PayStackResponse
    ...
    .. py:method:: async fetch_plan(id_or_code: str)→ PayStackResponse
    ...
    .. py:method:: async list_plans(per_page: int | None = 50, page: int | None = 1, status: str | None = None, interval: str | None = None, amount: int | None = None)→ PayStackResponse
    ...
    .. py:method:: async update_plan(id_or_code: str, name: str, amount: int, interval: str, send_invoices: bool, send_sms: bool, currency: str, invoice_limit: int, description: str | None = None)→ PayStackResponse
