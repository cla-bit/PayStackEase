...
.. py:class:: AsyncTransactionSplitClientAPI(secret_key: str = None)
    ...
    .. py:method:: async add_or_update_subaccount_split(split_id: str, subaccount: str, transaction_share: int)→ PayStackResponse
    ...
    .. py:method:: async create_split(transaction_split_name: str, transaction_split_type: str, currency: str, subaccounts: List[Dict[str, Any]], bearer_type: str, bearer_subaccount: str)→ PayStackResponse
    ...
    .. py:method:: async fetch_split(split_id: str)→ PayStackResponse
    ...
    .. py:method:: async list_split(split_name: str | None = None, active: bool | None = None, sort_by: str | None = None, per_page: int | None = None, page: int | None = None, from_date: date | None = None, to_date: date | None = None)→ PayStackResponse
    ...
    .. py:method:: async remove_sub_account_split(split_id: str, subaccount: str)→ PayStackResponse
    ...
    .. py:method:: async update_split(split_id: str, transaction_split_name: str, active: bool, bearer_type: str | None = None, bearer_subaccount: str | None = None)→ PayStackResponse
