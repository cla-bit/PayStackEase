"""
Demonstrates using Asynchronous and Synchronous Paystack Plans API wrappers.
Shows PayStackBase, and AsyncPayStaCKBase for interacting with Paystack's transactions.

Reference: https://paystack.com/docs/api/plan/ to learn more
"""
...
async def main():
    ...
    async with AsyncPayStackBase() as paystack_client:
        ...
        all_plans = await paystack_client.plans.list_plans()
