"""
Demonstrates using Asynchronous and Synchronous Paystack Payment Pages API wrappers.
Shows PayStackBase, and AsyncPayStaCKBase for interacting with Paystack's transactions.

Reference: https://paystack.com/docs/api/page/ to learn more
"""
...
async def main():
    ...
    async with AsyncPayStackBase() as paystack_client:
        ...
        update_page = await paystack_client.payment_pages.update_payment_page(
            page_id_or_slug="dk0gnrtfcw", name="Updated Testing Page"
        )
