"""
Demonstrates using Paystack Charges API wrappers.
Shows PayStackBase, and ChargesClientAPI for interacting with Paystack's transactions.

Reference: https://paystack.com/docs/api/charge/ to learn more
"""
...
async def main():
    ...
    async with AsyncPayStackBase() as paystack_client:
        ...
        print(f"Create charge: {create_charge}")
