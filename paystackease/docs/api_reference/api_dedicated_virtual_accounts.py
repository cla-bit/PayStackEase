"""
Demonstrates using Asynchronous and Synchronous Paystack Dedicated Virtual Account API wrappers.
Shows PayStackBase, and AsyncPayStaCKBase for interacting with Paystack's transactions.

Reference: https://paystack.com/docs/api/dedicated-virtual-account/ to learn more
"""
