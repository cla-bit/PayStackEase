"""
Demonstrates using Asynchronous and Synchronous Paystack Payment Requests  API wrappers.
Shows PayStackBase, and AsyncPayStaCKBase for interacting with Paystack's transactions.

Reference: https://paystack.com/docs/api/payment-request/ to learn more
"""
