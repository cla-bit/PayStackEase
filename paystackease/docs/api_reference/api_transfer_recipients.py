"""
Demonstrates using Asynchronous and Synchronous Paystack Transfer Recipients API wrappers.
Shows PayStackBase and AsyncPayStackBase for interacting with Paystack's verification.

Reference: https://paystack.com/docs/api/trasfer-recipient/ to learn more
"""
