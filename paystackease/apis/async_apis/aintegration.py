...
"""
from paystackease.helpers import integration_endpoint
...
class AsyncIntegrationClientAPI(AsyncRequestAPI):
    ...
    async def fetch_timeout(self) -> PayStackResponse:
        ...
        """
        return await self._get_request(integration_endpoint)
    ...
    async def update_timeout(self, timeout: int) -> PayStackResponse:
        ...
        return await self._put_request(integration_endpoint, data=data)
