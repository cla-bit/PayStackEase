...
from paystackease.helpers import balance_endpoint, transfer_endpoint
...
class AsyncTransferControlClientAPI(AsyncRequestAPI):
    ...
    async def check_balance(self) -> PayStackResponse:
        ...
        """
        return await self._get_request(balance_endpoint)
    ...
    async def fetch_balance_ledger(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"l{balance_endpoint}edger")
    ...
    async def resend_otp(self, transfer_code: str, reason: str) -> PayStackResponse:
        ...
        return await self._post_request(f"{transfer_endpoint}resend_otp", data=data)
    ...
    async def disable_otp(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._post_request(f"{transfer_endpoint}disable_otp")
    ...
    async def finalize_disable_otp(self, otp: str) -> PayStackResponse:
        ...
        """
        data = {"otp": otp}
        return await self._post_request(f"{transfer_endpoint}disable_otp_finalize", data=data)
    ...
    async def enable_otp(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._post_request(f"{transfer_endpoint}enable_otp")
