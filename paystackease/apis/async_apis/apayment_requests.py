...
from paystackease.helpers import PayMentRequestStatus, Currency, convert_to_string, payment_request_endpoint, \
    DatePageModel, PageModel
...
class AsyncPaymentRequestClientAPI(AsyncRequestAPI):
    ...
    async def create_payment_request(
        ...
        due_date = convert_to_string(due_date)
        ...
        return await self._post_request(payment_request_endpoint, data=data)
    ...
    async def list_payment_requests(
        ...
        include_archive = convert_to_string(include_archive)
        ...
        return await self._get_request(payment_request_endpoint, params=params)
    ...
    async def fetch_payment_request(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{payment_request_endpoint}{id_or_code}")
    ...
    async def verify_payment_request(self, code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{payment_request_endpoint}verify/{code}")
    ...
    async def send_notification(self, code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._post_request(f"{payment_request_endpoint}notify/{code}")
    ...
    async def payment_request_total(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{payment_request_endpoint}totals")
    ...
    async def finalize_payment_request(self, code: str, send_notification: bool) -> PayStackResponse:
        ...
        return await self._post_request(f"{payment_request_endpoint}finalize/{code}", data=data)
    ...
    async def update_payment_request(
        ...
        return await self._put_request(f"{payment_request_endpoint}{id_or_code}", data=data)
    ...
    async def archive_payment_request(self, code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._post_request(f"{payment_request_endpoint}archive/{code}")
