...
from paystackease.helpers import EventAction, EventType, terminal_endpoint, PageModel, CursorModel
...
class AsyncTerminalClientAPI(AsyncRequestAPI):
    ...
    async def send_event(
        ...
        return await self._post_request(f"{terminal_endpoint}{terminal_id}/event", data=data)
    ...
    async def commission_terminal(self, serial_number: str) -> PayStackResponse:
        ...
        return await self._post_request(f"{terminal_endpoint}commission_device", data=data)
    ...
    async def decommission_terminal(self, serial_number: str) -> PayStackResponse:
        ...
        """
        data = {"serial_number": serial_number}
        return await self._post_request(f"{terminal_endpoint}decommission_device", data=data)
    ...
    async def update_terminal(
        ...
        return await self._put_request(f"{terminal_endpoint}{terminal_id}", data=data)
    ...
    async def fetch_event_status(self, terminal_id: str, event_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{terminal_endpoint}{terminal_id}/event/{event_id}")
    ...
    async def fetch_terminal_status(self, terminal_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{terminal_endpoint}{terminal_id}/presence")

    async def list_terminals(
            self,
            page_model: Optional[PageModel] = None,
            cursor_values: Optional[CursorModel] = None,
    ) -> PayStackResponse:
        """
        ...
        params = {
            ...
            **(cursor_values.model_dump(by_alias=True) if cursor_values else {}),
        }
        return await self._get_request(terminal_endpoint, params=params)
    ...
    async def fetch_terminal(self, terminal_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{terminal_endpoint}timeline/{terminal_id}")
