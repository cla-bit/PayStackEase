...
class AsyncTransactionSplitClientAPI(AsyncRequestAPI):
    ...
    async def create_split(
        ...
        return await self._post_request(transaction_split_endpoint, data=data)
    ...
    async def add_or_update_subaccount_split(
        ...
        return await self._post_request(f"{transaction_split_endpoint}{split_id}/subaccount/add", data=data)
    ...
    async def remove_sub_account_split(self, split_id: str, subaccount: str) -> PayStackResponse:
        ...
        return await self._post_request(f"{transaction_split_endpoint}{split_id}/subaccount/remove", data=data)
    ...
    async def update_split(
        ...
        return await self._put_request(f"{transaction_split_endpoint}{split_id}", data=data)
    ...
    async def list_split(
        ...
        return await self._get_request(transaction_split_endpoint, params=params)
    ...
    async def fetch_split(self, split_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{transaction_split_endpoint}{split_id}")
