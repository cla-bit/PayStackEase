...
from paystackease.helpers import DisputeStatus, Resolution, PageModel, DatePageModel, dispute_endpoint, \
    convert_to_string
...
class AsyncDisputesClientAPI(AsyncRequestAPI):
    ...
    async def list_disputes(
        ...
        return await self._get_request(dispute_endpoint, params=params)
    ...
    async def fetch_dispute(self, dispute_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{dispute_endpoint}{dispute_id}")
    ...
    async def list_transaction_disputes(self, transaction_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{dispute_endpoint}transaction/{transaction_id}")
    ...
    async def update_dispute(
        ...
        return await self._put_request(f"{dispute_endpoint}{dispute_id}", data=data)

    async def add_evidence(
            self,
            dispute_id: str,
            customer_email: str,  # use CustomerDetails,but add email attribute to the class model
            customer_name: str,
            customer_phone: str,
            service_details: str,
        ...
        delivery_date = convert_to_string(delivery_date)
        ...
        return await self._post_request(f"{dispute_endpoint}{dispute_id}/evidence", data=data)
    ...
    async def get_upload_url(self, dispute_id: str, uploaded_filename: str) -> PayStackResponse:
        ...
        return await self._get_request(f"{dispute_endpoint}{dispute_id}/upload_url", params=params)
    ...
    async def resolve_dispute(
        ...
        return await self._put_request(f"{dispute_endpoint}{dispute_id}/resolve", data=data)
    ...
    async def export_disputes(
        ...
        return await self._get_request(f"{dispute_endpoint}export", params=params)
