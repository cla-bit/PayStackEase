...
class AsyncMiscellaneousClientAPI(AsyncRequestAPI):
    ...
    async def list_banks(
        ...
        **note::**
        ...
        return await self._get_request(misc_bank_endpoint, params=params)
    ...
    async def list_countries(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(misc_country_endpoint)
    ...
    async def list_states(self, country: str) -> PayStackResponse:
        ...
        return await self._get_request(misc_state_endpoint, params=params)
