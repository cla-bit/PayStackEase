...
from paystackease.helpers import TransactionStatus, Channels, Bearer, Currency, transaction_endpoint, MetaDataModel, \
...
class AsyncTransactionClientAPI(AsyncRequestAPI):
    ...
    async def initialize(
        ...
        return await self._post_request(f"{transaction_endpoint}initialize", data=data)
    ...
    async def charge_authorization(
        ...
        return await self._post_request(f"{transaction_endpoint}charge_authorization", data=data)
    ...
    async def partial_debit(
        ...
        return await self._post_request(f"{transaction_endpoint}partial_debit", data=data)
    ...
    async def list_transactions(
        ...
        return await self._get_request(transaction_endpoint, params=params)
    ...
    async def verify_transaction(self, reference: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{transaction_endpoint}verify/{reference}")
    ...
    async def fetch_transaction(self, transaction_id: int) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{transaction_endpoint}{transaction_id}")
    ...
    async def transaction_timeline(self, id_or_reference: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{transaction_endpoint}timeline/{id_or_reference}")
    ...
    async def transaction_totals(
        ...
        return await self._get_request(f"{transaction_endpoint}totals", params=params)
    ...
    async def export_transactions(
        ...
        return await self._get_request(f"{transaction_endpoint}export", params=params)
