...
class AsyncBulkChargesClientAPI(AsyncRequestAPI):
    ...
    async def initiate_bulk_charge(self, objects: Union[BulkChargeObject, List[BulkChargeObject]]) -> PayStackResponse:
        """
        ...
        return await self._post_request(bulk_charge_endpoint, data=data)
    ...
    async def list_bulk_charge_batches(
        ...
        return await self._get_request(bulk_charge_endpoint, params=params)
    ...
    async def fetch_charge_bulk_batch(
        ...
        return await self._get_request(f"{bulk_charge_endpoint}{id_or_code}/charges", params=params)
