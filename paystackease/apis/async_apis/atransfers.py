...
class AsyncTransfersClientAPI(AsyncRequestAPI):
    ...
    async def initiate_transfer(
        ...
        return await self._post_request(transfer_endpoint, data=data)
    ...
    async def finalize_transfer(self, transfer_code: str, otp: str) -> PayStackResponse:
        ...
        return await self._post_request(f"{transfer_endpoint}finalize_transfer", data=data)
    ...
    async def initiate_bulk_transfer(
        ...
        return await self._post_request(f"{transfer_endpoint}bulk", data=data)
    ...
    async def list_transfers(
        ...
        return await self._get_request(transfer_endpoint, params=params)
    ...
    async def fetch_transfer(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{transfer_endpoint}{id_or_code}")
    ...
    async def verify_transfer(self, reference: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._post_request(f"{transfer_endpoint}verify/{reference}")
