...
class AsyncSubAccountClientAPI(AsyncRequestAPI):
    ...
    async def create_subaccount(
        ...
        return await self._post_request(subaccount_endpoint, data=data)
    ...
    async def update_subaccount(
        ...
        return await self._put_request(f"{subaccount_endpoint}{id_or_code}", data=data)
    ...
    async def list_subaccounts(
        ...
        return await self._get_request(subaccount_endpoint, params=params)
    ...
    async def fetch_subaccount(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{subaccount_endpoint}{id_or_code}")
