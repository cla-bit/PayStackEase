...
from paystackease.helpers import misc_card_endpoint, misc_bank_endpoint
...
class AsyncVerificationClientAPI(AsyncRequestAPI):
    ...
    async def resolve_account(self, account_number: str, bank_code: str) -> PayStackResponse:
        ...
        return await self._get_request(f"{misc_bank_endpoint}resolve", params=params)
    ...
    async def validate_account(
        ...
        return await self._post_request(f"{misc_bank_endpoint}validate", data=data)
    ...
    async def resolve_card_bin(self, bin_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{misc_card_endpoint}{bin_code}")
