...
from paystackease.helpers import Interval, PageModel, plans_endpoint
...
class AsyncPlanClientAPI(AsyncRequestAPI):
    ...
    async def create_plan(
        ...
        return await self._post_request(plans_endpoint, data=data)
    ...
    async def list_plans(
        ...
        return await self._get_request(plans_endpoint, params=params)
    ...
    async def fetch_plan(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return await self._get_request(f"{plans_endpoint}{id_or_code}")
    ...
    async def update_plan(
        ...
        return await self._put_request(f"{plans_endpoint}{id_or_code}", data=data)
