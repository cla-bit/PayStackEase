...
class SubAccountClientAPI(PayStackBaseClientAPI):
    ...
    def create_subaccount(
        ...
        return self.post_request("/subaccount", data=data)
    ...
    def update_subaccount(
        ...
        return self.put_request(f"/subaccount/{id_or_code}", data=data)
    ...
    def list_subaccounts(
        ...
        return self.get_request("/subaccount", params=params)
    ...
    def fetch_subaccount(self, id_or_code: str) -> dict:
        ...
        :rtype: dict
        """
        return self.get_request(f"/subaccount/{id_or_code}")
