...
class TransferControlClientAPI(SyncRequestAPI):
    ...
    def check_balance(self) -> PayStackResponse:
        ...
        """
        return self._get_request(balance_endpoint)
    ...
    def fetch_balance_ledger(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{balance_endpoint}ledger")
    ...
    def resend_otp(self, transfer_code: str, reason: str) -> PayStackResponse:
        ...
        return self._post_request(f"{transfer_endpoint}resend_otp", data=data)
    ...
    def disable_otp(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._post_request(f"{transfer_endpoint}disable_otp")
    ...
    def finalize_disable_otp(self, otp: str) -> PayStackResponse:
        ...
        """
        data = {"otp": otp}
        return self._post_request(f"{transfer_endpoint}disable_otp_finalize", data=data)
    ...
    def enable_otp(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._post_request(f"{transfer_endpoint}enable_otp")
