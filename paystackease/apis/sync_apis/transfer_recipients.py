...
from paystackease.helpers import Currency, transfer_recipients_endpoint, MetaDataModel, BatchModel, PageModel, \
    DatePageModel
...
class TransferRecipientsClientAPI(SyncRequestAPI):
    ...
    def create_transfer_recipients(
        ...
        return self._post_request(transfer_recipients_endpoint, data=data)

    def bulk_create_transfer_recipient(self, batch: BatchModel) -> PayStackResponse:
        """
        ...
        return self._post_request(f"{transfer_recipients_endpoint}bulk", data=data)
    ...
    def list_transfer_recipients(
        ...
        return self._get_request(transfer_recipients_endpoint, params=params)
    ...
    def fetch_transfer_recipient(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{transfer_recipients_endpoint}{id_or_code}")
    ...
    def update_transfer_recipient(
        ...
        return self._put_request(f"{transfer_recipients_endpoint}{id_or_code}", data=data)
    ...
    def delete_transfer_recipient(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._delete_request(f"{transfer_recipients_endpoint}{id_or_code}")
