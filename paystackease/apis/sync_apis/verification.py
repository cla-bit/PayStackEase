...
class VerificationClientAPI(SyncRequestAPI):
    ...
    def resolve_account(self, account_number: str, bank_code: str) -> PayStackResponse:
        ...
        return self._get_request(f"{misc_bank_endpoint}resolve", params=params)
    ...
    def validate_account(
        ...
        return self._post_request(f"{misc_bank_endpoint}validate", data=data)
    ...
    def resolve_card_bin(self, bin_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{misc_card_endpoint}{bin_code}")
