...
class TerminalClientAPI(SyncRequestAPI):
    ...
    def send_event(
        ...
        return self._post_request(f"{terminal_endpoint}{terminal_id}/event", data=data)
    ...
    def commission_terminal(self, serial_number: str) -> PayStackResponse:
        ...
        return self._post_request(f"{terminal_endpoint}commission_device", data=data)
    ...
    def decommission_terminal(self, serial_number: str) -> PayStackResponse:
        ...
        """
        data = {"serial_number": serial_number}
        return self._post_request(f"{terminal_endpoint}decommission_device", data=data)
    ...
    def update_terminal(
        ...
        return self._put_request(f"{terminal_endpoint}{terminal_id}", data=data)
    ...
    def fetch_event_status(self, terminal_id: str, event_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{terminal_endpoint}{terminal_id}/event/{event_id}")
    ...
    def fetch_terminal_status(self, terminal_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{terminal_endpoint}{terminal_id}/presence")
    ...
    def list_terminals(
        ...
        return self._get_request(terminal_endpoint, params=params)
    ...
    def fetch_terminal(self, terminal_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{terminal_endpoint}timeline/{terminal_id}")
