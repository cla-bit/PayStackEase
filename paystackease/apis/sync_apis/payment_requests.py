...
from paystackease.helpers import PayMentRequestStatus, Currency, convert_to_string, payment_request_endpoint, PageModel, \
    DatePageModel
...
class PaymentRequestClientAPI(SyncRequestAPI):
    ...
    def create_payment_request(
        ...
        return self._post_request(payment_request_endpoint, data=data)
    ...
    def list_payment_requests(
        ...
        return self._get_request(payment_request_endpoint, params=params)
    ...
    def fetch_payment_request(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{payment_request_endpoint}{id_or_code}")
    ...
    def verify_payment_request(self, code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{payment_request_endpoint}verify/{code}")
    ...
    def send_notification(self, code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._post_request(f"{payment_request_endpoint}notify/{code}")
    ...
    def payment_request_total(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{payment_request_endpoint}totals")
    ...
    def finalize_payment_request(self, code: str, send_notification: bool) -> PayStackResponse:
        ...
        return self._post_request(f"{payment_request_endpoint}finalize/{code}", data=data)
    ...
    def update_payment_request(
        ...
        return self._put_request(f"{payment_request_endpoint}{id_or_code}", data=data)
    ...
    def archive_payment_request(self, code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._post_request(f"{payment_request_endpoint}archive/{code}")
