...
class PlanClientAPI(SyncRequestAPI):
    ...
    def create_plan(
        ...
        return self._post_request(plans_endpoint, data=data)
    ...
    def list_plans(
        ...
        return self._get_request(plans_endpoint, params=params)
    ...
    def fetch_plan(self, id_or_code: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{plans_endpoint}{id_or_code}")
    ...
    def update_plan(
        ...
        return self._put_request(f"{plans_endpoint}{id_or_code}", data=data)
