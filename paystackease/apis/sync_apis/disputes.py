...
class DisputesClientAPI(SyncRequestAPI):
    ...
    def list_disputes(
        ...
        return self._get_request(dispute_endpoint, params=params)
    ...
    def fetch_dispute(self, dispute_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{dispute_endpoint}{dispute_id}")
    ...
    def list_transaction_disputes(self, transaction_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{dispute_endpoint}transaction/{transaction_id}")
    ...
    def update_dispute(
        ...
        return self._put_request(f"{dispute_endpoint}{dispute_id}", data=data)
    ...
    def add_evidence(
        ...
        return self._post_request(f"{dispute_endpoint}{dispute_id}/evidence", data=data)
    ...
    def get_upload_url(self, dispute_id: str, uploaded_filename: str) -> PayStackResponse:
        ...
        return self._get_request(f"{dispute_endpoint}{dispute_id}/upload_url", params=params)
    ...
    def resolve_dispute(
        ...
        return self._put_request(f"{dispute_endpoint}{dispute_id}/resolve", data=data)
    ...
    def export_disputes(
        ...
        return self._get_request(f"{dispute_endpoint}export", params=params)
