...
class DedicatedVirtualAccountClientAPI(SyncRequestAPI):
    ...
    def create_virtual_account(
        ...
        return self._post_request(dvd_endpoint, data=data)
    ...
    def list_dedicated_account(
        ...
        return self._get_request(dvd_endpoint, params=params)
    ...
    def fetch_dedicated_account(self, dedicated_account_id: int) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{dvd_endpoint}{dedicated_account_id}")
    ...
    def requery_dedicated_account(
        ...
        return self._get_request(f"{dvd_endpoint}requery", params=params)
    ...
    def deactivate_dedicated_account(self, dedicated_account_id: int) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._delete_request(f"{dvd_endpoint}{dedicated_account_id}")
    ...
    def split_dedicated_account(
        ...
        return self._post_request(f"{dvd_endpoint}split", data=data)
    ...
    def remove_split_dedicated_account(self, account_number: str) -> PayStackResponse:
        ...
        return self._delete_request(f"{dvd_endpoint}split", data=data)
    ...
    def fetch_bank_providers(self) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{dvd_endpoint}available_providers")
