...
class ProductClientAPI(SyncRequestAPI):
    ...
    def create_product(
        ...
        return self._post_request(product_endpoint, data=data)
    ...
    def list_products(
        ...
        return self._get_request(product_endpoint, params=params)
    ...
    def fetch_product(self, product_id: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{product_endpoint}{product_id}")
    ...
    def update_product(
        ...
        return self._put_request(f"{product_endpoint}{product_id}", data=data)
