...
class PaymentPagesClientAPI(SyncRequestAPI):
    ...
    def create_payment_page(
        ...
        return self._post_request(payment_page_endpoint, data=data)
    ...
    def list_payment_pages(
        ...
        return self._get_request(payment_page_endpoint, params=params)
    ...
    def fetch_payment_page(self, page_id_or_slug: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{payment_page_endpoint}{page_id_or_slug}")
    ...
    def update_payment_page(
        ...
        return self._put_request(f"{payment_page_endpoint}{page_id_or_slug}", data=data)
    ...
    def check_slug_available(self, page_slug: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{payment_page_endpoint}check_slug_availability/{page_slug}")
    ...
    def add_products(self, payment_id: int, product: List[int]) -> PayStackResponse:
        ...
        return self._post_request(f"{payment_page_endpoint}{payment_id}/product", data=data)
