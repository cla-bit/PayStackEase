...
from paystackease.helpers import Currency, refund_endpoint, DatePageModel, PageModel
...
class RefundClientAPI(SyncRequestAPI):
    ...
    def create_refund(
        ...
        return self._post_request(refund_endpoint, data=data)
    ...
    def list_refunds(
        ...
        return self._get_request(refund_endpoint, params=params)
    ...
    def fetch_refund(self, reference: str) -> PayStackResponse:
        ...
        :rtype: PayStackResponse object
        """
        return self._get_request(f"{refund_endpoint}{reference}")
