...
class TransferControlClientAPI(PayStackBaseClientAPI):
    ...
    def fetch_balance_ledger(self) -> dict:
        ...
        :rtype: dict
        """
        return self.get_request("/balance/ledger")
    ...
    def resend_otp(self, transfer_code: str, reason: str) -> dict:
        ...
        return self.post_request("/transfer/resend_otp", data=data)
    ...
    def disable_otp(self) -> dict:
        ...
        :rtype: dict
        """
        return self.post_request("/transfer/disable_otp")
    ...
    def finalize_disable_otp(self, otp: str) -> dict:
        ...
        """
        data = {"otp": otp}
        return self.post_request("/transfer/disable_otp_finalize", data=data)
    ...
    def enable_otp(self) -> dict:
        ...
        :rtype: dict
        """
        return self.post_request("/transfer/enable_otp")
