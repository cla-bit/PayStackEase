...
class BulkChargesClientAPI(PayStackBaseClientAPI):
    ...
    def initiate_bulk_charge(self, objects: List[Dict[str, str]] = None) -> dict:
        ...
        :param objects: A list of dictionary with authorization codes, amount and reference as keys
        [{"authorization_code": "123456", "amount": 1000, "reference": "123456" }]

        :return: The response from the API
        :rtype: dict
        """
        return self.post_request("/bulkcharge", data=objects)
    ...
    def list_bulk_charge_batches(
        ...
        :param per_page:
        :param page:
        :param from_date: # 2016-09-24T00:00:05.000Z, 2016-09-21
        :param to_date:  # 2016-09-24T00:00:05.000Z, 2016-09-21
        ...
        return self.get_request("/bulkcharge", params=params)
    ...
    def fetch_bulk_charge_batch(self, id_or_code: str) -> dict:
        ...
        :rtype: dict
        """
        return self.get_request(f"/bulkcharge/{id_or_code}")
    ...
    def fetch_charge_bulk_batch(
        ...
        return self.get_request(f"/bulkcharge/{id_or_code}/charges", params=params)
    ...
    def pause_bulk_charge_batch(self, batch_code: str) -> dict:
        ...
        :rtype: dict
        """
        return self.get_request(f"/bulkcharge/pause/{batch_code}")
    ...
    def resume_bulk_charge_batch(self, batch_code: str) -> dict:
        ...
        :rtype: dict
        """
        return self.get_request(f"/bulkcharge/resume/{batch_code}")
